...
if(rbTree.root) {
    console.log(`9 : ${rbTree.search(9).color == RED ? "RED" : "BLACK"}`);
    console.log(`17 : ${rbTree.search(17).color == RED ? "RED" : "BLACK"}`);
    console.log(`19 : ${rbTree.search(19).color == RED ? "RED" : "BLACK"}`);
    console.log(`75 : ${rbTree.search(75).color == RED ? "RED" : "BLACK"}`);
    console.log(`85 : ${rbTree.search(85).color == RED ? "RED" : "BLACK"}`);
}
